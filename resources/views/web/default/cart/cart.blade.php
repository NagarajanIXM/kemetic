...
@section('content')
  ...
  <ul class="secure-benefits">
    <b><li>✅ 100% SSL Encrypted Checkout</li>
    <li>✅ 14-Day Money-Back Guarantee</li>
      <li>✅ Global payment methods</li>
        <li>✅ After pay with Klarna</li>
    <li>✅ Trusted by 20,500+ Members</b></li>
  </ul>
</div>
                ...
                <div class="col-12 col-lg-6">
                    <section class="mt-45">
                        ...
                        <div class="rounded-sm shadow mt-20 pb-20 px-20">
                            ...
                            @endif
<b>Join Our Growing Community of 20,500+ Members!
Unlock ancient wisdom, holistic practices, and exclusive courses tailored for your personal journey. Complete your purchase today to take the next step toward transformation and enlightenment.</b>

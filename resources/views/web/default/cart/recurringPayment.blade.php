...
<section class="container mt-45">
    ...
    <form action="{{ url('payments/recurringPayment-request') }}" method="post" class=" mt-25">
        {{ csrf_field() }}
        <input type="hidden" name="order_id" value="{{ $order->id }}">
        <div class="center-content">
            <!-- <h3>Your Payment is Secure</h3>
  <ul>
    <li>✅ SSL Encrypted & Safe Transactions</li>
    <li>✅ 14-Day Money-Back Guarantee</li>
    <li>✅ Trusted by 20,500+ Members</li>
  </ul> -->
            <h3 class="mb-2">
                Secure Your Access – Checkout with Confidence
            </h3>
            <p class="line_height_unset mb-3">🔒 Fast & Secure Payment with Stripe
                We use Stripe, a trusted global payment provider, to ensure your transaction is safe, fast, and seamless. Your payment details are encrypted and protected for worry-free checkout.</p>
        </div>
        <div class="row">
    ...
    <div style="display: absolute; justify-content: center; align-items: center; gap: 15px; margin-top: 20px;">
        <!-- <img src="/store/1/pages/checkout/checkout trust.webp" alt="Instant Access Icon" style="width: 250px; height: auto; transition: transform 0.3s ease;"> -->
        <h3 class="mb-2">💡 Why Choose Kemetic App?
        </h3>
        <ul class="mb-25">
            <li>✅ Instant Access to Courses, PDFs, and Exclusive Content</li>
            <li>✅ Over 20,500+ Students Already Learning & Growing</li>
            <li>✅ 100% Secure Payment with Leading Encryption Technology</li>
            <li>✅ Cancel Anytime – No Hidden Fees, No Hassle</li>
        </ul>
        <h3 class="mb-2">💳 Accepted Payment Methods:
        </h3>
        <ul class="mb-25">
            <li>Visa, MasterCard, American Express, PayPal, and Digital Wallets via Stripe and more!</li>

        </ul>
        <p class="line_height_unset mb-3">
            🚀 Complete Your Purchase & Unlock the Knowledge Now!
        </p>
...
@push('scripts_bottom')
<script src="{{ asset('assets/default/js/parts/payment.min.js') }}"></script>

...
.cookie-policy:hover {
    ...
    <div id="cookie-consent-banner" style="display: none;">
        <div class="cookie-content">
            <p>We use cookies to improve your experience. By continuing to use this site, you accept our <a class="cookie-policy" href="{{url('pages/privacy-policy')}}">Cookie Policy</a>.</p>
                    ...
                    <div class="subscribe-input bg-white p-10 flex-grow-1 mt-30 mt-md-0">
                        <form action="/newsletters" method="post">
                            ...
                            <div class="form-group d-flex align-items-center m-0">
                                ...
                                <!-- <a href="/landing-page" class="btn btn-primary rounded-pill">{{ trans('footer.join') }}</a> -->
                            </div>
                        </form>
                    </div>
                </div>

...
@if(!empty($navBtnUrl))
    <a href="{{ $navBtnUrl }}" class="d-none d-lg-flex btn btn-sm btn-primary nav-start-a-live-btn btn-navbar">
        {{ $navBtnText }}
    </a>

    <a href="{{ $navBtnUrl }}" class="d-flex d-lg-none text-white nav-start-a-live-btn font-14">
        {{ $navBtnText }}
    </a>
@endif

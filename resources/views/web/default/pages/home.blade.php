            ...
            <div class="col-12">
                <div class="marquee-block marquee1">
                    <ul class="marquee-item-list ps-0">
                        ...
                        <li> <img src="/assets/default/img/home/payment.svg" class="" alt="connection-img">
...
<div class=" position-relative subscribes-container pe-none user-select-none mb-50" id="memberShip">
    ...
    <section class="container home-sections home-sections-swiper membership-div">
        <div class="text-center text-white">
            <h1 class="section-title text-white mb-2">{{ trans('home.subscribe_now') }}</h1>
            <h5 class="text-gray200 fw500 mobile-text14 text-white mb-3">{{ trans('home.subscribe_now_hint') }}</h5>
            <h5 class="mb-2 mobile-text14">{{ trans('home.subscribe_now_hint1') }}</h5>
            <h6 class="mb-2 mobile-text14">{{ trans('home.subscribe_now_hint2') }}</h6>
            <h6 class="mobile-text14">{{ trans('home.subscribe_now_hint3') }}</h6>
        </div>
...
<section class="home-sections home-sections-swiper container">
    ...
    <div class="feature-slider-container position-relative d-flex justify-content-center mt-10">
        <div class="swiper-container features-swiper-container pb-25 m-0 w-100">
            <div class="swiper-wrapper py-10">
                @foreach($featureWebinars as $feature)
                <div class="swiper-slide event-slide w-100">
        ...
        <div class="swiper-pagination features-swiper-pagination event-pagination"></div>
    </div>
</section>
@endif
...
<section class="home-sections home-sections-swiper container">
    ...
    <div class="mt-30 position-relative">
        ...
        <a href="/classes?type[]=bundle" class="btn btn-border-white btn-primary">{{ trans('home.view_all') }}</a>
        </div>
    </div>
</section>
@endif
...
<section class="home-sections home-sections-swiper container">
    <div class="d-flex justify-content-between ">
        <div class="text-center">
            <h1 class="section-title">{{ trans('home.latest_classes') }}</h1>
            <h3 class="mb-2">{{ trans('home.latest_webinars_hint') }}</h3>
            <p class="mb-2">{{ trans('home.latest_webinars_hint1') }}</p>
            <p class="mb-2">{{ trans('home.latest_webinars_hint2') }}</p>
            <h3 class="mb-2">{{ trans('home.latest_webinars_hint3') }}</h3>
    ...
    <div class="mt-30 position-relative">
        <div class="swiper-container best-rates-webinars-swiper px-12">
            <div class="swiper-wrapper py-20">
                ...
                <div class="swiper-slide popular-card h-auto ">
        ...
        <div class="text-center mt-30">
            <a href="/classes?sort=newest" class="btn btn-border-white btn-primary">{{ trans('home.view_all') }}</a>
        </div>
    </div>
</section>
@endif
...
<section class="home-sections home-sections-swiper container">
    ...
    <div class="mt-10 position-relative">
       ...
       <div class="text-center mt-30"> <a href="/products" class="btn btn-primary">{{ trans('update.all_products') }}</a></div>
    </div>
</section>
@endif
...
<section class="home-sections home-sections-swiper container find-instructor-section position-relative">
    <div class="row align-items-center">
        <div class="col-12 col-lg-7">
            <div class="pr-lg-5">
                <h2 class="font-24 font-weight-bold text-dark">{{ $becomeInstructorSection['title'] ?? '' }}</h2>
                <p class="font-14 font-weight-normal text-gray mt-10">{{ $becomeInstructorSection['description'] ?? '' }}</p>
                <ul class="pl-5 experience-ul">
                    <li class="font-14 font-weight-normal text-gray mt-10">{{ trans('home.experience_li1') }}</li>
                    <li class="font-14 font-weight-normal text-gray mt-10">{{ trans('home.experience_li2') }}</li>
                    <li class="font-14 font-weight-normal text-gray mt-10">{{ trans('home.experience_li3') }}</li>
                </ul>
                <p class="font-14 font-weight-normal text-gray mt-10">{{ trans('home.experience_p') }}</p>
                <div class="mt-35 d-flex align-items-center">
...
<section class="home-sections home-sections-swiper container find-instructor-section position-relative">
    <div class="row align-items-center ">
        <div class="col-12 col-lg-6 mt-20 mt-lg-0 mb-4 mb-lg-0">
            <div class="position-relative d-flex justify-content-center">
...
<section class="home-sections home-sections-swiper container">
    ...
    <div class="position-relative mt-20">
        ...
        <div class="text-center mt-30">
        <a href="/organizations" class="btn btn-border-white btn-primary">{{ trans('home.all_organizations') }}</a>
        </div>
    </div>
</section>
@endif 
...
<section class="home-sections container">
    ...
    <div class="row mt-35">
        ...
        @endforeach
        <div class="text-center w-100 mt-30"> <a href="/blog" class="btn btn-primary">{{ trans('home.all_articles') }}</a></div>
    </div>
</section>
@endif
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    setTimeout(function() {
        if (window.location.hash === '#memberShip') {
            ...
            if (targetElement) {
                const offset = 75; // The desired top offset in pixels
    ...
    }, 300); // Adding a slight delay to ensure the element is in the DOM
});

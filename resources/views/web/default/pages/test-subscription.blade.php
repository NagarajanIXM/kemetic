...
<section>
    ...
    <div class="activities-container mt-25 p-20 p-lg-35">
        <div class="row">
            ...
            <div class="col-4 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ asset('assets/default/img/activity/53.svg') }}" width="64" height="64" alt="">
...
<section class="mt-30">
    ...
    <div class="row mt-15">
        ...
        <div class="col-12 col-sm-6 col-lg-4 mt-15">
            <div class="card subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20 text-center h-100">
                <div class="card-body p-0 border-0 bg-transparent d-flex flex-column align-items-center">
                    ...
                    <div class="d-flex align-items-start mt-30">
                        ...
                        @else
                        <span class="font-36 text-primary line-height-1 hover-text-price">{{ handlePrice($subscribe->price, true, true, false, null, true) }}</span>
                        @endif
                        @else
                        <span class="font-36 text-primary line-height-1 hover-text-price">{{ trans('public.free') }}</span>
                        @endif
                    </div>

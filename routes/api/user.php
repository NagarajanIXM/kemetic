...
Route::group([], function () {
    ...
    //khushboo 5-12-24
    Route::post('/purchase', ['uses' => 'SubscribesController@coursePurchase']);
    Route::post('/storeAddress', ['uses' => 'UsersController@storeAddress']);
    // Route::post('/storeAddress', ['uses' => 'CartController@updateProductOrders']);
    //khushboo 5-12-24
    ...
    Route::group(['prefix' => 'subscribe'], function () {
        ...
        Route::post('/payment_success', ['uses' => 'SubscribesController@paymentSuccess']);
    ...
    Route::group(['prefix' => '/classes'], function () {
        ...
        Route::get('/store', ['uses' => 'WebinarsController@store', 'middleware' => ['api.level-access:teacher']]);
    });
    ...
    Route::group(['prefix' => '/cart'], function () {
        ...
        //khushboo 3-12-24
        // Route::post('add', ['uses' => 'CartController@addProducttoCart']);
    ...
    Route::group(['prefix' => 'store'], function () {
        Route::group(['middleware' => ['api.level-access:teacher']], function () {
            ...
            //khushboo 28-11-24
            Route::post('/products/create', ['uses' => 'ProductController@store']);
